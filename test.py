...
horoscope_data = {
    ...
    "황소자리": [
        "꾸준함이 큰 힘을 발휘해요 🐂",
        "맛있는 음식을 먹으면 에너지가 충전돼요 🍲",
        "작은 성과도 소중히 여겨야 해요 🌿"
    ],
    "쌍둥이자리": [
        "대화 속에서 행운이 숨어있어요 💬",
        "전화 한 통이 좋은 소식을 가져올 거예요 📞",
        "새로운 만남이 기대되는 날이에요 🌟"
    ],
    "게자리": [
        "가족이나 친구와의 시간이 소중해요 🦀",
        "집안일을 정리하면 마음이 편안해져요 🏠",
        "따뜻한 한마디가 좋은 기운을 불러와요 💖"
    ],
    "사자자리": [
        "자신감을 가지면 좋은 결과가 와요 🦁",
        "사람들 앞에서 빛나는 하루예요 ✨",
    ...
    "처녀자리": [
        "세심함이 당신을 빛나게 해요 🌸",
        "계획적으로 움직이면 일이 잘 풀려요 📋",
        "작은 디테일에서 행복을 발견할 수 있어요 🌼"
    ],
    "천칭자리": [
        "균형 잡힌 하루, 조화가 필요해요 ⚖️",
        "친구와의 대화에서 위로를 얻을 수 있어요 💬",
        "예쁜 것을 보면 마음이 맑아져요 🌷"
    ],
    "전갈자리": [
        "집중력이 높아 성과가 커져요 🦂",
    ...
    "사수자리": [
        "여행이나 모험이 행운을 가져와요 🏹",
        "새로운 배움이 즐거움을 줄 거예요 📘",
        "활동적인 하루가 당신을 반짝이게 해요 🌞"
    ],
    "염소자리": [
        "성실함이 빛나는 하루예요 ⛰️",
        "노력의 결실을 조금씩 맛볼 거예요 🌱",
        "작은 목표를 이루면 큰 자신감을 얻어요 💪"
    ]
}
...
random.seed(today.toordinal())  # 오늘 기준으로 고정
